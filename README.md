...
- 男方賓客（工程師：程式碼變成照片）— 綠色字元從上方落下、聚合成合照的形狀，接著縮成圓點解析出五官，駭客綠褪回照片原色，最後兩人之間浮出心形。鏡頭全程從側後方推進到正面。
- 女方賓客（印刷廠：CMYK 印出照片）— 一張白紙翻著飛進畫面，四支滾輪接連刷過青、洋紅、黃、黑，刷過的地方才有墨，最後成品浮起、暖光暈開。鏡頭全程繞著紙走，紙面自己會抖、會捲。
...
- **無障礙 / 略過動畫**：兩支 3D 動畫都提供「略過動畫」按鈕與自動播放完畢後的「進入婚禮資訊」按鈕，避免動畫成為使用者取得資訊的阻礙。動畫本身壓在 4.6 秒，播完再停 0.7 秒就自動進資訊頁。
