...
export const weddingData = {
  ...
  // 日期時間（ISO 格式，含時區）－ 用於倒數計時與「加入行事曆」
  // 開始時間 18:00 就是流程第一列的賓客報到時間（開席是 18:30）。
  // 結束時間用於行事曆的事件長度（流程最後是 21:00 送客，抓到 21:30）。
  ...
  // 流程
  schedule: [
    { time: '18:00', title: '賓客報到', desc: '簽名、入席、拿小禮、留聲機玩起來' },
    { time: '18:30', title: '婚宴開席', desc: '新人交換誓言與戒指' },
    { time: '19:00', title: '宴會活動', desc: '來就知道....' },
